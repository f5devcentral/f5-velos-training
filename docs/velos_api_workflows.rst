...
`System Controller Monitoring Health via API <https://clouddocs.f5.com/training/community/velos-training/html/monitoring_velos.html#system-controller-monitoring-health-via-api>`_
