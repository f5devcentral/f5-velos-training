...
.. Note:: You cannot mix BX110 and BX520 blades in the same CX410 chassis unless you are running the F5OS-C 1.8.1 release. When mixing blade types in the same CX410 chassis they must be put into their own unique chassis partitions. You cannot mix different blade types within the same chassis partition.  
