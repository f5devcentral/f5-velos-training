...
In general, for BIG-IP tenants TMOS versions 14.1.4 and later, 15.1.4 and later, and 17.1.x, 17.5 and later, and 21.x and later are supported on the BX110 blades in the CX410 chassis. Although some of the older 14.x/15.x TMOS releases have now reached End of Technical Support. Versions 16.0.x, 16.1.x, or 17.0.x were never supported on VELOS. For the BX520 blade, the minimum supported TMOS version is 17.1.2 and later, 17.5.x and 21.x.
